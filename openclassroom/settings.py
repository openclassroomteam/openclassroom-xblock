"""
Django settings for the Open Classroom XBlock project.
...
LOCALE_PATHS = [
    os.path.join(BASE_DIR, 'openclassroom/translations'),
]

# statici18n
# http://django-statici18n.readthedocs.io/en/latest/settings.html

with open(os.path.join(BASE_DIR, 'openclassroom/translations/config.yaml'), 'r') as locale_config_file:
...
# `OpenClassroomI18N` might collide with other modules, using `OpenClassroomXBlockI18N` to be more explicit
STATICI18N_NAMESPACE = 'OpenClassroomXBlockI18N'
STATICI18N_PACKAGES = (
    'openclassroom',
)
STATICI18N_ROOT = 'openclassroom/static/js'
